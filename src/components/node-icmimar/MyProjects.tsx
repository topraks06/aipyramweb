...
export default function MyProjects() {
    const { user, loading, isLicensed } = useSovereignAuth('icmimar');
    ...
    const triggerConceirgeEdit = (project: any) => {
        ...
        window.dispatchEvent(new CustomEvent('open_icmimar_ai_assistant', { 
    ...
    if (user && !isLicensed) {
        return (
            <div className="flex flex-col items-center justify-center bg-white border border-[#111]/10 py-20 px-6 text-center shadow-sm">
                ...
                <Link href="/sites/icmimar/pricing">
