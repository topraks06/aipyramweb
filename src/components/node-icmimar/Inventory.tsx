    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="bg-zinc-900 border-white/10">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <button onClick={() => window.location.href = '/sites/icmimar/catalog'} className="text-[10px] font-bold uppercase tracking-widest px-4 py-2 bg-white text-black hover:bg-zinc-200 transition-colors rounded">
            Kataloğa Git
          </button>
        </CardHeader>
