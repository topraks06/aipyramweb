      ...
      <footer className="py-24 bg-[#F9F9F6] border-t border-[#111111]/10 px-6 md:px-12 text-[#111111] font-sans">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-12 mb-24">
            ...
            {/* Col 1 */}
            <div>
              <h4 className="text-[#111] font-bold uppercase tracking-[0.2em] text-[9px] mb-8">Icmimar Türleri</h4>
              <ul className="space-y-4 text-[10px] font-medium text-zinc-500 tracking-[0.1em] uppercase">
                <li><Link href="#" title="Çok Yakında" className="hover:text-black transition-colors">Fon Icmimar</Link></li>
                <li><Link href="#" title="Çok Yakında" className="hover:text-black transition-colors">Tül Icmimar</Link></li>
                <li><Link href="#" title="Çok Yakında" className="hover:text-black transition-colors">Stor Icmimar</Link></li>
                <li><Link href="#" title="Çok Yakında" className="hover:text-black transition-colors">Zebra Icmimar</Link></li>
                ...
                <li><Link href="#" title="Çok Yakında" className="hover:text-black transition-colors">Panel Icmimar</Link></li>
              </ul>
            </div>
