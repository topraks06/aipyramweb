      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-zinc-900 border-white/10">
          <CardContent className="p-6">
            ...
            <p className="text-[10px] text-zinc-500 mt-2">İcmimar.ai üzerinden yönetilen yerel satışların toplam hacmi.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-zinc-900 border-white/10">
          <CardContent className="p-6">
            ...
            <p className="text-[10px] text-zinc-500 mt-2">İcmimar.ai "Sınırsız Tasarım" güncel abonelik ücretiniz.</p>
          </CardContent>
        </Card>
      </div>
