      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-zinc-950 border-white/5 overflow-hidden group hover:border-blue-500/50 transition-colors">
          ...
          <CardHeader>
            ...
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
              TRTEX haber portalÄ± kendi otonom altyapÄ±sÄ±nda Ã§alÄ±ÅŸÄ±r. Bir haber kapaÄŸÄ±na veya editoryal gÃ¶rsele ihtiyaÃ§ duyduÄŸunda, Perde.ai ajanÄ±yla iletiÅŸime geÃ§ip gÃ¶rseli anÄ±nda teslim alÄ±r.
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-zinc-950 border-white/5 overflow-hidden group hover:border-purple-500/50 transition-colors">
          ...
          <CardHeader>
            ...
            <p className="text-xs text-zinc-400 leading-relaxed font-medium">
              Sanal fuar stantlarÄ± ve sergi alanlarÄ±. Hometex sistemi yeni bir 3D stant render'Ä±na ihtiyaÃ§ duyduÄŸunda, Perde.ai ajanÄ±nÄ± tetikleyerek veriyi kendi platformuna Ã§eker.
            </p>
          </CardHeader>
          <CardContent>
             <div className="w-full mt-4 bg-black border border-white/5 text-zinc-500 font-mono text-[10px] p-3 rounded-lg flex items-center justify-between">
        ...
        <Card className="bg-zinc-950 border-white/5 overflow-hidden group hover:border-[#8B7355]/50 transition-colors relative">
          ...
          <CardHeader>
            ...
            <CardTitle className="text-2xl font-bold tracking-tight uppercase text-white">PERDE.AI</CardTitle>
