...
const DICT: Record<string, any> = {
  ...
  fr: {
    ...
    uploadPromptMsg: "Maintenant, veuillez télécharger les images des produits que vous souhaitez utiliser en cliquant sur le trombone ci-dessous.",
                                  ...
                                  <button 
                                      ...
                                      onClick={async (e) => {
                                         ...
                                         try {
                                             ...
                                             const newOrder = {
                                                tenantId: 'perde', // client context fallback
                                                authorId: 'seller', 
