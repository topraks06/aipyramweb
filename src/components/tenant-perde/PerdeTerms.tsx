...
export default function PerdeTerms() {
      ...
      <section className="max-w-[1000px] mx-auto px-6 md:px-12">
         ...
         <div className="bg-white p-8 md:p-12 border border-[#111]/10 shadow-sm mb-12">
            <p className="text-zinc-500 font-medium leading-relaxed">
               Bu sözleşme, Perde.AI tarafından sunulan Bulut ERP, Smart Visualizer (WebGL Render) ve REST API hizmetlerinin B2B ticari kullanımı için geçerli olan sınırlamaları ve yükümlülükleri belirler. Hizmetlerimizi kullanarak bu şartları şirketiniz adına yasal olarak kabul etmiş sayılırsınız.
            </p>
         </div>
         ...
         <div className="space-y-12">
            ...
            <div className="flex gap-6">
               ...
               <div>
                  ...
                  <p className="text-zinc-500 font-medium leading-relaxed">
                     Platform üzerinden oluşturulan 3D Render ve PDF fatura çıktıları, lisans süreniz boyunca firmanızın ticari kullanımına aittir. Ancak &quot;Perde.AI&quot; render motoru yapısı, arayüz kodları, yapay zeka ağırlıkları ve &quot;Smart Visualizer&quot; marka hakları tamamen İsviçre merkezli Aipyram GmbH şirketine aittir. Reverse-engineering veya sistemin kopyalanması kesinlikle yasaktır.
                  </p>
               </div>
            </div>
