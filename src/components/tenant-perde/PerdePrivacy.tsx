...
export default function PerdePrivacy() {
         ...
         <div className="space-y-12">
            ...
            <div className="flex gap-6">
               ...
               <div>
                  ...
                  <p className="text-zinc-500 font-medium leading-relaxed">
                     B2B entegrasyon süreçlerinde sağlanan kurumsal kimlik, bayi bilgileri, fiyatlandırma stratejileri ve fatura/proforma dataları uçtan uca şifrelenir ve izole tenant (kiracı) mimarisinde tutulur.
                  </p>
               </div>
            </div>
            ...
            <div className="flex gap-6">
               ...
               <div>
                  ...
                  <p className="text-zinc-500 font-medium leading-relaxed">
                     Perde.AI, kurumsal verilerinizi veri komisyoncularına veya reklam ağlarına ASLA satmaz. Verileriniz yalnızca Stripe (Ödeme altyapısı), Google Cloud (Sunucu altyapısı) gibi zorunlu uluslararası hizmet sağlayıcılarımızla güvenli protokoller çerçevesinde paylaşılır.
                  </p>
               </div>
            </div>
         </div>
