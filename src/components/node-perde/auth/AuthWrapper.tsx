...
export default function AuthWrapper({ children, title, subtitle, basePath = '/sites/perde.ai' }: { children: React.ReactNode, title: string, subtitle?: string, basePath?: string }) {
  return (
    <div className="min-h-screen bg-[#F9F9F6] flex font-sans selection:bg-[#8B7355]/30 relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative items-center justify-center overflow-hidden">
        <img 
          src="/assets/perde.ai/perde.ai (13).jpg" 
          alt="Perde.ai Premium Interior"
        ...
        <div className="relative z-10 p-16 max-w-lg">
          ...
          <p className="text-white/50 text-sm font-light leading-relaxed">
            Oda fotoğrafınızı yükleyin, saniyeler içinde fotorealistik perde tasarımları alın. 
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="absolute top-8 left-8 right-8 flex items-center justify-between">
          ...
          <span className="font-serif text-lg tracking-tight text-zinc-900 font-medium">PERDE.AI</span>
        </div>
