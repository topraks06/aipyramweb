...
export default function OrderSlideOver({ isOpen, onClose, order, isCreateMode }: OrderSlideOverProps) {
  const { user, SovereignNodeId } = useSovereignAuth('perde');
                ...
                <div className="p-6">
                  <form onSubmit={handleCreateOrder} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input required type="text" value={newOrder.title} onChange={e => setNewOrder({...newOrder, title: e.target.value})} className="w-full border border-zinc-200 p-2 text-sm rounded focus:outline-none focus:border-zinc-400" placeholder="Örn: Salon Fon Perde" />
                    </div>
                    <div>
