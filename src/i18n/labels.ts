...
const labels: Record<string, Record<LangCode, string>> = {
  ...
  registerNow:         { tr: 'SİSTEME KAYIT OL', en: 'REGISTER NOW', de: 'JETZT REGISTRIEREN', ru: 'ЗАРЕГИСТРИРОВАТЬСЯ', zh: '立即注册', ar: 'سجل الآن', es: 'REGISTRARSE AHORA', fr: "S'INSCRIRE MAINNODE" },
