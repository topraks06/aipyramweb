...
export default function ArticleClient({
  ...
  const T_DICT: Record<string, any> = {
    ...
    DE: { expand: 'VERGRÖSSERN', execSummary: 'ZUSAMMENFASSUNG', ceoSummary: 'CEO BRIEFING', opportunities: 'CHANCEN', actions: 'WAS TUN?', trend: '3-MONATS-PROGNOSE', market: 'MARKT', marketSize: 'MARKTGRÖSSE', riskLevel: 'RISIKOSTUFE', readMore: 'WEITERLESEN', risk: 'RISIKO', action: 'AKTION', opportunity: 'CHANCE', actionText: 'SCHNELLE AKTION', source: 'Quelle:', author: 'AUTOR:', disclaimer: 'HAFTUNGSAUSSCHLUSS', disclaimerText: 'Marktanalysen auf der Plattform sind keine Anlageberatung.' },
    ...
    ZH: { expand: '展开', execSummary: '执行摘要', ceoSummary: 'CEO 摘要', opportunities: '商业机会', actions: '该怎么办？', trend: '3个月预测', market: '市场', marketSize: '市场规模', riskLevel: '风险等级', readMore: '阅读更多', risk: '风险', action: '行动', opportunity: '机会', actionText: '快速行动', source: '来源:', author: '作者:', disclaimer: '免责声明', disclaimerText: 'TRTEX 平台上的市场分析并非投资建议。' },
    AR: { expand: 'توسيع', execSummary: 'الملخص التنفيذي', ceoSummary: 'ملخص الرئيس التنفيذي', opportunities: 'الفرص التجارية', actions: 'ماذا يجب أن تفعل؟', trend: 'توقعات 3 أشهر', market: 'السوق', marketSize: 'حجم السوق', riskLevel: 'مستوى الخطر', readMore: 'اقرأ المزيد', risk: 'خطر', action: 'عمل', opportunity: 'فرصة', actionText: 'إجراء سريع', source: 'المصدر:', author: 'المؤلف:', disclaimer: 'إخلاء المسؤولية', disclaimerText: 'تحليل السوق ليس نصيحة استثمارية.' },
    ES: { expand: 'AMPLIAR', execSummary: 'RESUMEN EJECUTIVO', ceoSummary: 'RESUMEN DEL CEO', opportunities: 'OPORTUNIDADES', actions: '¿QUÉ HACER?', trend: 'PRONÓSTICO DE 3 MESES', market: 'MERCADO', marketSize: 'TAMAÑO DEL MERCADO', riskLevel: 'NIVEL DE RIESGO', readMore: 'LEER MÁS', risk: 'RIESGO', action: 'ACCIÓN', opportunity: 'OPORTUNIDAD', actionText: 'ACCIÓN RÁPIDA', source: 'Fuente:', author: 'AUTOR:', disclaimer: 'DESCARGO DE RESP', disclaimerText: 'El análisis de mercado proporcionado no es asesoramiento de inversión.' },
    FR: { expand: 'AGRANDIR', execSummary: 'RÉSUMÉ EXÉCUTIF', ceoSummary: 'RÉSUMÉ DU PDG', opportunities: 'OPPORTUNITÉS', actions: 'QUE FAIRE?', trend: 'PRÉVISIONS SUR 3 MOIS', market: 'MARCHÉ', marketSize: 'TAILLE DU MARCHÉ', riskLevel: 'NIVEAU DE RISQUE', readMore: 'LIRE LA SUITE', risk: 'RISQUE', action: 'ACTION', opportunity: 'OPPORTUNITÉ', actionText: 'ACTION RAPIDE', source: 'Source:', author: 'AUTEUR:', disclaimer: 'CLAUSE DE NON', disclaimerText: 'L\'analyse de marché n\'est pas un conseil en investissement.' },
  };
